...
return (
    <>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group cursor-crosshair">
                  <div className="font-mono text-xs break-all bg-black border-2 border-red-900/30 p-4 flex justify-between items-center overflow-hidden min-h-[52px]">
                    ...
                    {/* Masking Layer (Fades out on hover instead of instant hide) */}
      ...
      {publicKey && 
      <TransferModal isOpen={showTransferModal} onClose={()=>setShowTransferModal(false)} fromPublicKey={publicKey} />
      }
    </>
  );
};
